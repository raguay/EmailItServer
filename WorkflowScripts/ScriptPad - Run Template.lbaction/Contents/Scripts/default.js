...
function getTemplateList() { 
   return HTTP.getJSON("http://localhost:9978/api/template/list").data.templates
}

function runTemplate(obj) {
   var result = HTTP.loadRequest(HTTP.createRequest("http://localhost:9978/api/template/run", {
      method: "PUT",
      body: obj,
      bodyType: "json",
      resultType: "json"
